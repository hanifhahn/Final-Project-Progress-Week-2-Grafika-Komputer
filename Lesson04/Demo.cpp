...
void Demo::Render() {
	...
	//Air
	for (double i = -29.5; i <= 29.5; i++) {
		for (double j = -29.5; j <= 29.5; j++) {
			DrawColoredCubeWater(j, 0.0, i);
		}
	}
	...
	for (double i = -29.5; i <= -4.5; i++) {
		for (double j = -4.5; j >= -17.5; j--) {
			DrawColoredCubeSand(i, 1.0, j - temp1);
		}
	...
	//DrawColoredCubeSand(1.0, 0.0, 1.0);
	//DrawColoredCubeSand(2.0, 0.0, 1.0);
	//DrawColoredCubeSand(3.0, 0.0, 1.0);
...
int main(int argc, char** argv) {
	...
	app.Start("Bjorky", 800, 600, false, false);
	//vsync, fullscreen
}